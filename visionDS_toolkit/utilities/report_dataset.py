...
def generate_dataset_report_pdf(
    ...
    if has_segmentation and total_annotations > 0:
        ...
        # Mask size distribution (instance size by mask)
        ...
        # Polygon complexity + mask/bbox tightness
